...
const items: MenuItem[] = [
  ...
  getItem('Manage Users', '/npmmanage-users', <UserOutlined />, undefined, [
    getItem('User', '/dashboard/manage-users', undefined, '/dashboard/manage-users'),
    getItem('Role', '/dashboard/manage-users/role', undefined, '/dashboard/manage-users/role'),
    getItem('Permission', '/dashboard/manage-users/permission', undefined, '/dashboard/manage-users/permission')
  ]),
];
  ...
  return (
    ...
    >
      <Layout style={{ minHeight: "100vh" }}>
        ...
        >
          <div className="lg:bg-gray-100 rounded-md lg:m-2" ><p className='w-full lg:text-xl font-bold lg:py-2 text-center text-primary lg:m-2 my-2'>Boilerplate</p></div>
